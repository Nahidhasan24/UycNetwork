...
import com.motionadsltdns.uycnetwork.databinding.ActivityInviteBinding;
...
public class InviteActivity extends AppCompatActivity {
        ...
        mRef.child(mAuth.getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        double mainPoint = currentCoin + config.getReferuse();
                        BigDecimal bd = new BigDecimal(mainPoint).setScale(5, RoundingMode.HALF_UP);
                        double newInput = bd.doubleValue();
                        double p = newInput;
    ...
    private void inits() {
        ...
        mConfig.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
